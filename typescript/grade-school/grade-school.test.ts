...
describe('School', () => {
  ...
  // this test case honestly does not feel in sync with the rest of the test case, it requires a total different set of data structure.
